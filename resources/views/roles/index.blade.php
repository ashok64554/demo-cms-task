                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    ...
                                    @endcan
                                    @can('role-delete')
                                    <a class="btn btn-sm btn-danger" href="{{ route('role-delete',$role->id) }}" onClick="return confirm('Are you sure you want to delete this?');"><i class="fa fa-trash"></i> </a>
                                    @endcan
                                    <a class="btn btn-sm btn-info" href="{{ route('roles.show',$role->id) }}"><i class="fa fa-info-circle"></i> </a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
