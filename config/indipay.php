...
return [
    ...
    */
    ...
    'payumoney' => [                         // PayUMoney Parameters
        ...
        // Should be route address for url() function
        'successUrl' => env('INDIPAY_SUCCESS_URL', 'payment-response'),
        'failureUrl' => env('INDIPAY_FAILURE_URL', 'payment-response'),
    ],
    ...
    'ebs' => [                         // EBS Parameters
        ...
        // Should be route address for url() function
        'return_url' => env('INDIPAY_SUCCESS_URL', 'payment-response'),
    ],
    ...
    'citrus' => [                         // Citrus Parameters
        ...
        // Should be route address for url() function
        'returnUrl' => env('INDIPAY_SUCCESS_URL', 'payment-response'),
        'notifyUrl' => env('INDIPAY_SUCCESS_URL', 'payment-response'),
    ],
